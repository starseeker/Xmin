...
generated core keysyms plus mutable modifier/repeat/button mappings and feedback controls,
including atomic invalid-update rejection, mapping-busy replies, and silent bell validation,
