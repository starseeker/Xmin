#ifndef XMIN_SERVER_EXTENSION_REGISTRY_HPP
#define XMIN_SERVER_EXTENSION_REGISTRY_HPP
...
inline constexpr ExtensionInfo glx_extension{
    "GLX", 146, 75, 151, 1, 4, ExtensionKind::glx};
