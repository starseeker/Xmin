 ...
 * obtain drawable geometry and present pixels through an existing XCB
 * connection.  The token is private to Xmin: it must only be passed to the
 * glX entry points exported by Xmin::GL.
 */
