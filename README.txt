...
SYNC provides typed counters, alarms, fences, priorities, extension errors and events.
Await and AwaitFence suspend only the requesting client in the poll loop; another client
